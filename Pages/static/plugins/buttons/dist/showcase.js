$(document).ready(function(){
  ...
  var page = {
    ...
    attachScrollMonitor: function() {
      ...
      //Don't want a footer when header is visible鈥eriod
      ...
      $(window).scroll(function() {
        ...
        //cleared鈥揾appens until alloted time elapsed since last scroll
    ...
    activateCopyButton: function($showcase, code) {
      ...
      client.on( "ready", function( readyEvent ) {
        ...
        client.on( "copy", function(event) {
          ...
          button.text('宸插鍒讹紒').addClass('is-selected');

          setTimeout(function() {
            button.html('<i class="fa fa-cut"></i> 澶嶅埗').removeClass('is-selected');
          }, 1000);
        });
      });
    },
